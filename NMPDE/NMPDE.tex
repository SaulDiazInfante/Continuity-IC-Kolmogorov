...
%
    ...
    \begin{titlepage}
        ...
        \begin{abstract}
            %Background
            Accoring to the numerical scheme reported in 
            [Infin. Dimens. Anal. Quantum Probab. Relat. Top. {\bf 19} (2016), 
            no.~3, 1650020, 37 pp.],
            we characterize numerical stability respect to initial conditions. 
            Our approach consists in solving the associated Kolmogorov
            equation for a familiy of parabolic SPDE whit a spectral method 
            and deduce mild conditions. We
