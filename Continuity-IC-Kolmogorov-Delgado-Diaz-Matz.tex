...
\begin{abstract}
    ...
    numerically the associated 
    Kolmogorov equation of the underlying SPDE whit a spectral method. We 
    illustrate our results with numerical experiments.
\end{abstract}
%
\begin{keywords}
    Stability, spectral methods, Kolmogorov equation, stochastic parabolic equations.
\end{keywords}
%
\begin{AMS}
    60H10, 65C20, 35Q84
...
(t-s)}P_{t-s}(B,D\Psi_s^\varphi) ds \ .
\end{align*}
Then,
\begin{align*}
...
\section{Conclusions}
    \todo{
        Resume, connect with other literature 
        and stress the relevance of our results
    }
