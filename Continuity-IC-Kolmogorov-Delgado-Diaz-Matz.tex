...
\begin{abstract}
    ...
    particular family of SPDEs. Our approach follows the idea of solving the 
    associated Kolmogorov equation to the underlying SPDE whit a spectral 
    approach. We also run numerical experiments to illustrate our results.
%    
